...
all:
	g++ -DUNICODE -DPSAPI_VERSION=1 -D_WIN32_WINNT=0x0601 main.cpp $(VIEW_SOURCES) $(CONTROLLER_SOURCES) $(IMG_SOURCES) $(MODEL_SOURCES) -IView/imgui -IView/imgui/backends -Ilib/include -Llib -lglfw3 -lopengl32 -lgdi32 -ldwmapi -limm32 -lole32 -loleaut32 -luuid -static -o dashboard.exe -lpsapi
