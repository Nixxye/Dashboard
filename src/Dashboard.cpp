...
int main(void) {
    ...
    for (WindowsInfo::Process process : processes) {
        ...
        std::cout << "Parent ID: " << process.parentId << std::endl;
        ...
        for (WindowsInfo::Thread thread : process.getThreads()) {
            std::cout << "\tThread ID: " << thread.id << std::endl;
            std::cout << "\tPriority Base: " << thread.getPriorityBase() << std::endl;
            std::cout << "\tPriority Delta: " << thread.getPriorityDelta() << std::endl;
        }
    }
    return( TRUE );
}